                        ...
                        onPressed: () async {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Confirm work assign?'),
                                    content: Text(valueOrDefault<String>(
                                      functions
                                          .newCustomFunction(widget.jobPrice!),
                                      'Error',
                                    )),
                                    actions: [
                                      TextButton(
                          ...
                          if (confirmDialogResponse) {
                            if (functions.newCustomFunction2(
                                valueOrDefault<String>(
                                  valueOrDefault(currentUserDocument?.money, 0)
                                      .toString(),
                                  '0',
                                ),
                                widget.jobPrice!)!) {
                              ...
                              final usersUpdateData = {
                                'money':
                                  ...
                                  functions
                                      .newCustomFunction3(widget.jobPrice!),
                                  0,
                                ))),
                              };
                              ...
                              confirmDialogResponse = await showDialog<bool>(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Insuffiicient balance'),
                                        content: Text(
                                            'You dont have enough balance to assign this work'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext, false),
