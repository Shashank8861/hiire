          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ViewCustomerWidget(
                ...
                jobPrice: params.getParam('jobPrice', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'requesters',
            ...
            FFRoute(
              name: 'acceptedList',
              path: 'acceptedList',
              builder: (context, params) => AcceptedListWidget(),
            ),
            FFRoute(
              name: 'bank',
              path: 'bank',
            ...
            FFRoute(
              name: 'bankform',
              path: 'bankform',
              builder: (context, params) => BankformWidget(),
            ),
            FFRoute(
              name: 'panForm',
              path: 'panForm',
              builder: (context, params) => PanFormWidget(),
            )
