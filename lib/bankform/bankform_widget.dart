...
class BankformWidget extends StatefulWidget {
  const BankformWidget({Key? key}) : super(key: key);

  @override
  _BankformWidgetState createState() => _BankformWidgetState();
}

class _BankformWidgetState extends State<BankformWidget>
